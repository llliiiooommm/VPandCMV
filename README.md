...
| [`lab1`](https://github.com/llliiiooommm/VPandCMV/tree/lab1) | Создание обычных функций в соответствии с заданием			| Документация и README                 |        ✅        |
| [`lab2`](https://github.com/llliiiooommm/VPandCMV/tree/lab2) | Утилиты, Jest-тесты и настройка CI/CD | 🛠 В разработке |
